...
namespace CryoDI
{
	public static class ContainerExtensions
	{
		...
		public  static CryoContainer RegisterType<TBase, TDerived, THdClass>(this CryoContainer container) where TDerived : TBase, new()
		{
			return container.RegisterProvider<TBase>(new FactoryMethodProvider<TDerived>(LifeTime.Global), typeof(THdClass).ToString());
		}
