	...
	public class CryoContainer : IDisposable
	{
		...
		private void BuildUp(Type type, object obj, Param[] parameters)
		{
			...
			foreach (PropertyInfo property in properties)
			{
				...
				var hardDependencyAttr = property.GetCustomAttributes(typeof(HardDependencyAttribute), true).FirstOrDefault() as HardDependencyAttribute;
				if (hardDependencyAttr != null)
				{
					ProcessDependency(type, obj, property, hardDependencyAttr.Name.ToString());
					continue;
				}
